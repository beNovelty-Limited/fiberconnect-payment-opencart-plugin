...
Note: Opencart v2.3 or v3.0.3.1 - 3.0.3.6 must be installed for this plugin to work.
...
2. Adapt the decompressed files and directories according to the current status of the Opencart v2.3 or v3.0 installation group and user access rights.
3. Copy content of the directory “src” into the Opencart  v2.3 or v3.0 main directory, thus over­writing the previous files/directories.
