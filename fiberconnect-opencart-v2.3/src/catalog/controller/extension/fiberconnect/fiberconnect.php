...
class ControllerExtensionFiberConnect extends Controller
{
	...
	public function callback()
	{
		...
		$status_code	= $this->config->get( $this->code . '_' . $status_id . '_status_id' );
	...
	public function getPaymentUrl()
	{
		...
		if (isset($post_link['gw_url'])) {
			...
			$order_status_id	= $this->config->get( 'fiberconnect_pending_status_id' );
	...
	protected function initApi() {
		FiberConnectApi::$api_key = $this->config->get('fiberconnect_api_key');
	}
